        ...
        <td width="250" valign="top"><br/>
        	<table class="wp-list-table widefat fixed bookmarks">
                ...
                <tr>
                	<td>
                    <ul class="wmle_list">
                    	<li><a href="http://www.masonrylayout.com/documentations/" target="_blank">View Documentation</a></li>
                        <li><a href="http://www.masonrylayout.com/forums/forum/lite-version/" target="_blank">Visit Support Forum</a></li>
                        <li><a href="http://www.masonrylayout.com/rectify-my-problem/" target="_blank">Rectify My Problem</a></li>
                        <li><a href="http://www.masonrylayout.com/contact-us/" target="_blank">Contact Us</a></li>
                        <li><a href="http://www.masonrylayout.com/features/" target="_blank">Check Pro Features</a></li>
                    </ul>
                    </td>
                </tr>
                </tbody>
