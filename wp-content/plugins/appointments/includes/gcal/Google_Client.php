...
if (file_exists(dirname(__FILE__)  . '/local_config.php')) {
  $defaultConfig = $App_apiConfig;
  require_once (dirname(__FILE__)  . '/local_config.php');
  $App_apiConfig = array_merge($defaultConfig, $App_apiConfig);
}
...
class Google_Client {
  ...
  public function __construct($config = array()) {
    ...
    $App_apiConfig = array_merge($App_apiConfig, $config);
    self::$cache = new $App_apiConfig['cacheClass']();
    self::$auth = new $App_apiConfig['authClass']();
    self::$io = new $App_apiConfig['ioClass']();
  }
  ...
  public function setApplicationName($applicationName) {
    global $App_apiConfig;
    $App_apiConfig['application_name'] = $applicationName;
  }
  ...
  public function setClientId($clientId) {
    global $App_apiConfig;
    $App_apiConfig['oauth2_client_id'] = $clientId;
  ...
  public function setClientSecret($clientSecret) {
    global $App_apiConfig;
    $App_apiConfig['oauth2_client_secret'] = $clientSecret;
  ...
  public function setRedirectUri($redirectUri) {
    global $App_apiConfig;
    $App_apiConfig['oauth2_redirect_uri'] = $redirectUri;
  ...
  public function setUseObjects($useObjects) {
    global $App_apiConfig;
    $App_apiConfig['use_objects'] = $useObjects;
  }
