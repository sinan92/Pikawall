		...
		if ( !$results ) {
			...
			foreach ( $results as $result ) {
				...
				if ( $result->duration > 1440 ) {
					echo '<div class="error"><p>' .
						__('<b>[Appointments]</b> One of your services has a duration greater than 24 hours. Appointments plugin does not support services exceeding 1440 minutes (24 hours). ', 'appointments') .
					'</p></div>';
					$r = true;
					break;
				}
